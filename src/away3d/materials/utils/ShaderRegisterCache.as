package away3d.materials.utils
{
	...
	{
		private var _fragmentTempCache : RegisterPool;                   //ft
		private var _vertexTempCache : RegisterPool;                     //vt
		private var _varyingCache : RegisterPool;                        //v
		private var _fragmentConstantsCache : RegisterPool;              //fc
		private var _vertexConstantsCache : RegisterPool;                //vc
		private var _textureCache : RegisterPool;                        //fs
		private var _vertexAttributesCache : RegisterPool;               //va
		private var _vertexConstantOffset : uint;             
		private var _vertexAttributesOffset : uint;

		private var _fragmentOutputRegister : ShaderRegisterElement;     //oc
		private var _vertexOutputRegister : ShaderRegisterElement;       //op
